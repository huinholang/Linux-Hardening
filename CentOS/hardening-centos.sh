#!/bin/bash
## Hardening Script for Linux CentOS Server.
### Made by Huinholag 2020(c)
#### Special thank's to: 
...
### INTRODUCTION
tput setaf 1; echo "Disabling Legacy Filesystems"
...
tput setaf 1; echo "Removing legacy services..."
...
tput setaf 1; echo "Removing setroubleshoot.."
yum -y remove setroubleshoot

tput setaf 1; echo "Removing mcstrans..."
yum -y remove mcstrans

tput setaf 1; echo "Disabling LDAP..."
...
tput setaf 1; echo "Upgrading password hashing algorithm to SHA512..."
authconfig --passalgo=sha512 --update

tput setaf 1; echo "Setting core dump security limits..."
echo '* hard core 0' > /etc/security/limits.conf

tput setaf 1; echo "Generating additional logs..."
...
### AUDITD SECTION
tput setaf 1; echo "Instaling auditd..."
...
-a always,exit -F arch=b64 -S kexec_load -k exec
-a always,exit -F arch=b32 -S sys_kexec_load -k exec
-a always,exit -F arch=b64 -S kill -k kill-process
-a always,exit -F arch=b32 -S kill -k kill-process
...
### CRON SECTION
tput setaf 1; echo "Configuring Cron and Anacron..."
...
### BANNER SECTION
tput setaf 1; echo "Creating Banner..."
...
### SSH SECTION
tput setaf 1; echo "Configuring SSH..."
...
echo "CHANGE SSH PORT, TO DIFFERENT E.G 5020"


systemctl restart sshd >> $AUDITDIR/service_restart_$TIME.log

tput setaf 1; echo "Setting default umask for users..."
...
### FILESYSTEM SECTION
tput setaf 1; echo "Verifying System File Permissions..."
...
tput setaf 1; echo "Reviewing User and Group Settings..."
...
tput setaf 1; echo "Checking root PATH integrity..."
...
### PERMISSIONS SECTION
tput setaf 1; echo "Checking Permissions on User Home Directories..."
...
tput setaf 1; echo "Modifying Network Parameters..."
...
### IPV6 SECTION
tput setaf 1; echo "Disabling IPv6..."
...
### PAM SECTION
tput setaf 1; echo "Restricting Access to the su Command..."
...
### AIDE SECTION
tput setaf 1; echo "AIDE..."
yum install aide -y
aide --init
mv /var/lib/aide/aide.db.new.gz /var/lib/aide/aide/db.gz
aideline="0 5 * * * /usr/bin/aide --check"
(crontab -u root -l; echo "$aideline") | crontab -u root -


### IPTABLES SECTION
tput setaf 1; echo "Disabling firewalld..."
systemctl stop firewalld
systemctl disable firewalld
systemctl mask --now firewalld

tput setaf 1; echo "Iptables configuring..."
...
function create-users() {
        ...
        echo "$hash" | passwd --stdin "$user" &> /dev/null
        tput setaf 3; echo "Password for $user : $hash"
        chage -d 0 $user
